        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EndCoordinates = table.Column<string>(type: "text", nullable: false),
                    ...
                    WeatherTemperatureC = table.Column<double>(type: "double precision", nullable: false),
                    WeatherHumidity = table.Column<int>(type: "integer", nullable: false),
                    WeatherWindSpeed = table.Column<double>(type: "double precision", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_EcoRoutes", x => x.Id);
                    table.ForeignKey(
                        name: "FK_EcoRoutes_AspNetUsers_CreatedById",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EcoRouteId = table.Column<int>(type: "integer", nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Comments_EcoRoutes_EcoRouteId",
                        column: x => x.EcoRouteId,
                        principalTable: "EcoRoutes",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_ForumLikes_ForumPosts_PostId",
                        column: x => x.PostId,
                        principalTable: "ForumPosts",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
